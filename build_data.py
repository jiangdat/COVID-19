...
tf.flags.DEFINE_string('X_input_dir', './data/COVID-19',
                       'X input directory, default: ./data/COVID-19')
tf.flags.DEFINE_string('Y_input_dir', './data/CANCER',
                       'Y input directory, default: ./data/CANCER')
tf.flags.DEFINE_string('X_output_file', './data/COVID2CANCER.tfrecords',
                       'X output tfrecords file, default: ./data/COVID2CANCER.tfrecords')
tf.flags.DEFINE_string('Y_output_file', './data/CANCER2COVID.tfrecords',
                       'Y output tfrecords file, default: ./data/CANCER2COVID.tfrecords')
