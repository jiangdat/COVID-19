...
tf.flags.DEFINE_string('X', './data/COVID2CANCER.tfrecords',
                       'X tfrecords file for training, default: ./data/COVID2CANCER.tfrecords')
tf.flags.DEFINE_string('Y', './data/CANCER2COVID.tfrecords',
                       'Y tfrecords file for training, default: ./data/CANCER2COVID.tfrecords')
